...
//   };
//   const isToday = (date: Date) => formatDate(date) === formatDate(new Date());
//   const isAllowed = (date: Date) => allowedDates.length === 0 || allowedDates.includes(formatDate(date));

//   return (
//     <div className="bg-white p-3 pt-2 border-b">
//       <div className="flex items-center justify-between">
//         <button onClick={() => changeWeek(-1)} className="p-1">
//           <ChevronLeft size={20} />
//         </button>
//         {weekDates.map((date, i) => {
//           const dateStr = formatDate(date);
