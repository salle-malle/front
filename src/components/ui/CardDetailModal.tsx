...
import { Dialog, DialogTitle, DialogContent, DialogHeader, DialogDescription, DialogFooter } from "./dialog";
...
export const CardDetailModal = ({
  ...
  useEffect(() => {
    if (card) {
      setLocalScrapState(card.isScrap || false);
    ...
    <>
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogPrimitive.Portal>
          ...
          >
            <DialogTitle className="sr-only">뉴스 상세보기</DialogTitle>
